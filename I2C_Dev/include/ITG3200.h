...
#define TEMP_OUT           0x1B  // R	SENSOR: Temperature 2uint8_ts
#define GYRO_XOUT          0x1D  // R	SENSOR: Gyro X 2uint8_ts  
#define GYRO_YOUT          0x1F  // R	SENSOR: Gyro Y 2uint8_ts
#define GYRO_ZOUT          0x21  // R	SENSOR: Gyro Z 2uint8_ts
...
public:
  ...
  void readmem(uint8_t _addr, uint8_t _nuint8_ts, uint8_t * _buff);
  
private:
  int fI2C; // File pointer/descriptor to the I2C port
